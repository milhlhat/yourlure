...
function Shoe(props) {
	...
	let texture1 = useTexture(props.imgLink ? props.imgLink : whiteImg);
	let texture2 = useTexture(props.imgLinkSole ? props.imgLinkSole : whiteImg);
		...
		<div className="customize">
			<Canvas shadows dpr={[1, 2]} camera={{ position: [0, 0, 4], fov: 50 }}>
				...
				<Suspense fallback={null}>
					<Shoe imgLink={props.imgLink} imgLinkSole={props.imgLinkSole} color={props.color} />
...
export default function Customize() {
	const imgLink = useSelector((state) => state.customizeImg.mesh);
	...
	return (
		<div className="row">
			...
			<div className="col-md-6">
				{' '}
				<CanvasModel imgLink={imgLink} imgLinkSole={imgLinkSole} color={color} />{' '}
			</div>
		</div>
	);
}
